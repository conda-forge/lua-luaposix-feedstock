...
Linux: [![Circle CI](https://circleci.com/gh/conda-forge/lua-luaposix-feedstock.svg?style=shield)](https://circleci.com/gh/conda-forge/lua-luaposix-feedstock)
OSX: [![TravisCI](https://travis-ci.org/conda-forge/lua-luaposix-feedstock.svg?branch=master)](https://travis-ci.org/conda-forge/lua-luaposix-feedstock)
Windows: ![](https://cdn.rawgit.com/conda-forge/conda-smithy/90845bba35bec53edac7a16638aa4d77217a3713/conda_smithy/static/disabled.svg)

Current release info
====================
Version: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/lua-luaposix/badges/version.svg)](https://anaconda.org/conda-forge/lua-luaposix)
Downloads: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/lua-luaposix/badges/downloads.svg)](https://anaconda.org/conda-forge/lua-luaposix)
...
Once the `conda-forge` channel has been enabled, `lua-luaposix` can be installed with:

```
conda install lua-luaposix
```

It is possible to list all of the versions of `lua-luaposix` available on your platform with:
