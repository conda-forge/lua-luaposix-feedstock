...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/lua-luaposix-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/lua-luaposix-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add lua-luaposix
# for installing globally
pixi global install lua-luaposix
```
...
It is possible to list all of the versions of `lua-luaposix` available on your platform:
...
```
pixi search lua-luaposix --channel conda-forge
```
